{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 12.0, 161.0, 640.0, 480.0 ],
		"bglocked" : 0,
		"defrect" : [ 12.0, 161.0, 640.0, 480.0 ],
...
, 			{
				"box" : 				{
					"description" : "fmat $steps.length 2",
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 150.0, 15.0, 187.666016, 19.0 ],
					"persistence" : 0,
					"presentation_rect" : [ 150.0, 15.0, 187.666016, 19.0 ],
					"scope" : 0,
					"text" : "fmat $steps.length 2"
				}
