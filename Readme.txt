...
To listen to examples in this patch you will have to download the required samples (http://www.audibledata.com/Download_files/samples_for_ag.granular.suite.zip) and place them in max/msp search path.
